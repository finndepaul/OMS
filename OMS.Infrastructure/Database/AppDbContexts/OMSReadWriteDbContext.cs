...
{
    public class OMSReadWriteDbContext : DbContext
    {
        public DbSet<Order> Orders { get; set; }
        public DbSet<OrderDetail> OrderDetails { get; set; }
        public DbSet<Product> Products { get; set; }
        public OMSReadWriteDbContext(DbContextOptions<OMSReadWriteDbContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(OMSReadWriteDbContext).Assembly);
        }
    }
}
